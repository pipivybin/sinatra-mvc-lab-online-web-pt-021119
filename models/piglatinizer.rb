class PigLatinizer
  ...
  def piglatinize(text)
    ...
    elsif (second_letter || third_letter) != "a" && second_letter || third_letter!= "e" && second_letter != "i" && second_letter != "o" && second_letter != "u" && (third_letter = "a" || third_letter = "e" || third_letter = "i" || third_letter = "o" || third_letter = "u")
      word_arr.shift
      word_arr.shift
